...
class TherapistController extends Controller
{
    ...
    public function add()
    {
        return view('admin.therapist.add_compounder');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/therapist/list');
    }
    ...
    public function list()
    {
        $doctors = DB::table('compounders')
            ...
            ->get();
        return view('admin.therapist.list_compounder', ['doctors' => $doctors]);
    }
    ...
    public function edit($id, $uid)
    {
        ...
        return view('admin.therapist.compounder_edit_form', compact('id', 'uid', 'doctor'));
    }
